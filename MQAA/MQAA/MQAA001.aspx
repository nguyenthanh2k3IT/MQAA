...
<body class="hold-transition skin-blue sidebar-mini" style="height: 800px; width: 1280px; margin: 0 auto;">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // Populate modal dropdowns with current values
            $('#addRowModal').on('show.bs.modal', function () {
                $('#inputFactory').val($('#cboFCT_LIST').val() || 'VT1');
                $('#inputWeekly').val($('#cboWeekly').val() || 'w1');
            });
        });
    ...
    <script>
        ...
        // function calculateDayFrom() {
        //     var monthly = $("#cbpMonthly").val() || "4";
        //     var year = "2025";
        //     return year + monthly.padStart(2, '0') + "01";
        // }

        // function calculateDayTo() {
        //     var monthly = $("#cbpMonthly").val() || "4";
        //     var year = "2025";
        //     return year + monthly.padStart(2, '0') + "30";
        // }
        ...
        var tableData = []; // Store the table data
